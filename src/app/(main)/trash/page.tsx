            ...
            <div className="mb-6">
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-[300px] text-center">
                        <div className="w-[124px] h-[124px] mb-4 opacity-50 bg-black/5 dark:bg-white/5 rounded-full flex items-center justify-center">
                            <span className="text-[48px]">🗑️</span>
                        </div>
                        <h3 className="text-[16px] font-medium text-[#1f1f1f] dark:text-[#e3e3e3] mb-2">Trash is empty</h3>
                        <p className="text-sm text-[#5f6368] dark:text-[#9aa0a6]">Items in trash will be deleted forever after 30 days</p>
                    </div>
                ) : (
